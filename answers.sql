...
-- Insert data into the new table (1 row per product)
...
-- Create a separate table for Customer details
...
-- Create a new OrderDetails table without partial dependency
